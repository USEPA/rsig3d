...
namespace qmapcontrol
{
	...
	TileMapAdapter("mt1.google.com", "/vt/lyrs=s&x=%2&y=%3&z=%1", 256, 2, 17)  
    {
    }
	...
	/*
    GoogleSatMapAdapter::GoogleSatMapAdapter():
	//TileMapAdapter("khm1.google.com", "/kh/v=101&x=%1&y=%2&z=%3", 256, 1, 17)  //not working now
	TileMapAdapter("mt1.google.com", "/vt/lyrs=y&x=%2&y=%3&z=%1", 256, 1, 17)    //hybrid map, works
    {
        // name = "googlesat";
    ...
    {
        int random = qrand() % 4;
        return QString("mt%1.google.com").arg(random);
    }
...
*/
	...
	GoogleSatHybridMapAdapter::GoogleSatHybridMapAdapter():
	TileMapAdapter("mt1.google.com", "/vt/lyrs=y&x=%2&y=%3&z=%1", 256, 2, 17)  
    {
    }
	...
	MapQuestMapAdapter::MapQuestMapAdapter():
	TileMapAdapter("otile3.mqcdn.com", "/tiles/1.0.0/osm/%1/%2/%3.png", 256, 2, 17) 
    {
    }
