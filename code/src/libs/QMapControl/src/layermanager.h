...
namespace qmapcontrol
{
    ...
    public:
         ...
         */
        void setView(const QPointF& coordinate, bool genOffscreenImage=false);
        ...
        //! zooms in one step
        void zoomIn(bool buildNewOffscreenImage=true);

        //! zooms out one step
        void zoomOut(bool buildNewOffscreenImage=true);
