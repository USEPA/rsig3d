...
public:
	...
	static const LambertConformalConicProjection s_lambertconformalProjection;
...
const LambertConformalConicProjection ViewportParamsPrivate::s_lambertconformalProjection;
...
void ViewportParams::setProjection(Projection newProjection)
{
    ...
    switch ( newProjection ) {
		...
		case LambertConformalConic:
			d->m_currentProjection = &d->s_lambertconformalProjection;
			break;
		case Stereographic:
			d->m_currentProjection = &d->s_stereographicProjection;
			break;
    }
