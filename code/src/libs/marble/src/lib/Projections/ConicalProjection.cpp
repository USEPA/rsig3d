...
ConicalProjectionPrivate::ConicalProjectionPrivate( ConicalProjection * parent )
...
ConicalProjection::ConicalProjection()
        : AbstractProjection( * new ConicalProjectionPrivate( this ) )
{
}

ConicalProjection::ConicalProjection( ConicalProjectionPrivate &dd )
...
QPainterPath ConicalProjection::mapShape( const ViewportParams *viewport ) const
{
...
bool ConicalProjection::screenCoordinates( const GeoDataLineString &lineString,
                                                  const ViewportParams *viewport,
                                                  QVector<QPolygonF *> &polygons ) const
{

    Q_D( const ConicalProjection );
...
bool ConicalProjectionPrivate::lineStringToPolygon( const GeoDataLineString &lineString,
                                              const ViewportParams *viewport,
                                              QVector<QPolygonF *> &polygons ) const
{
...
void ConicalProjectionPrivate::repeatPolygons( const ViewportParams *viewport,
                                                QVector<QPolygonF *> &polygons ) const
{
    Q_Q( const ConicalProjection );
