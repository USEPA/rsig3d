                                            ...
                                            qreal& x, qreal& y ) const
{
    ...
    x = ( width  * 0.5 + ( lon - centerLon ) * rad2Pixel );
    y = ( height * 0.5 - ( lat - centerLat ) * rad2Pixel );
                                            ...
                                            qreal &x, qreal &y, bool &globeHidesPoint ) const
{
    ...
    x = ((qreal)(viewport->width()) * 0.5 + rad2Pixel * (lon - centerLon));
    y = ((qreal)(viewport->height()) * 0.5 - rad2Pixel * (lat - centerLat));
