...
#ifndef INC_COLOR_2012_H_
#define INC_COLOR_2012_H_
...
class Color : public PropertyInterface
{
	Q_OBJECT
...
private Q_SLOTS:
	void setValue(ObjectInfo* info, const QColor& c);
};

} //namespace PropertyEditor

#endif //INC_COLOR_2012_H_
