...
Size::Size(QObject* parent, QObject* object, int property, const PropertyModel * propertyModel): 
...
bool Size::canHandle(QObject * object, int propertyID) const
{
...
PropertyInterface* Size::createInstance(QObject* parentptr, QObject * object, int property, const PropertyModel * propertyModel) const
{
	if (parentptr==NULL) parentptr=parent();
	return new Size(parentptr, object, property, propertyModel);
}
