...
Font::Font(QObject* parent, QObject* object, int property, const PropertyModel* propertyModel): 
...
bool Font::canHandle(QObject * object, int propertyID)const
{
...
PropertyInterface* Font::createInstance(QObject* parentptr, QObject * object, int property, const PropertyModel * propertyModel) const
{
	if (parentptr==NULL) parentptr=parent();
	return new Font(parentptr, object, property, propertyModel);
}
