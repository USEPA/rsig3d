...
bool Date::canHandle(QObject * object, int propertyID)const
{
...
PropertyInterface* Date::createInstance(QObject* parentptr, QObject * object, int property, const PropertyModel * propertyModel) const
{
	if (parentptr==NULL) parentptr=parent();
	return new Date(parentptr, object, property, propertyModel);
}
