...
*/
class TimeProp : public PropertyInterface
{
	Q_OBJECT
	Q_INTERFACES(PropertyEditor::PropertyInterface);

public:
	TimeProp(QObject* parent = 0, QObject* object = 0, int property = -1, const PropertyModel * propertyModel = 0);
