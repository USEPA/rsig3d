...
PropertyInterface* Flags::createInstance(QObject* parentptr, QObject * object, int property, const PropertyModel * propertyModel) const
{
	if (parentptr==NULL) parentptr=parent();
	return new Flags(parentptr, object, property, propertyModel);
}
