...
Brush::Brush(QObject* parent, QObject* object, int property, const PropertyModel * propertyModel): 
...
bool Brush::canHandle(QObject * object, int propertyID) const
{
...
PropertyInterface* Brush::createInstance(QObject* parentptr, QObject * object, int property, const PropertyModel * propertyModel) const
{
	if (parentptr==NULL) parentptr=parent();
	return new Brush(parentptr, object, property, propertyModel);
}
