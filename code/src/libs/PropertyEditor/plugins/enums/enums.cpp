...
bool Enums::canHandle(QObject * object, int propertyID)const
{
...
PropertyInterface* Enums::createInstance(QObject* parentptr, QObject * object, int property, const PropertyModel * propertyModel) const
{
	if (parentptr==NULL) parentptr=parent();
	return new Enums(parentptr, object, property, propertyModel);
}
