...
int
nc_inq_format( int unused, int* formatp )
{
...
{
	size_t chunk_size_hint = 256 * 1024;
	const int result = nc__open(path, ioflags, &chunk_size_hint, ncid_ptr);
/* fprintf( stderr, "chunk_size_hint = %lu\n", chunk_size_hint ); */
	return result;
}
