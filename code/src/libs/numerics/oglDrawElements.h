/******************************************************************************
 PURPOSE: oglDrawElements.h - implements some OpenGL rendering functions
 
 NOTES:   Directly call OpenGL APIs
 
 HISTORY: 2013/04/8, zhang.nan@epa.gov, Created.
 ******************************************************************************/


#ifndef OGL_DRAW_ELEMENTS_
#define OGL_DRAW_ELEMENTS_
...
#include "vectorall.h"  //Vector3d, Vector3f
