...
/** @file
 * This file contains the headers for StereographicProjection.
 *
 */
...
class StereographicProjection : public AbstractProjection
{
 public:
 ...
 private:
    ...
    qreal m_referenceLatitude;
};

}

#endif //MARBLE_STEREOGRAPHICPROJECTION_H
