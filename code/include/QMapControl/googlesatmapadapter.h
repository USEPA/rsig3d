 ...
 */
    ...
    class GoogleSatHybridMapAdapter : public TileMapAdapter
    {
        Q_OBJECT
    public:
        GoogleSatHybridMapAdapter();
        virtual ~GoogleSatHybridMapAdapter();
	};

	
    class MapQuestMapAdapter : public TileMapAdapter
    {
        Q_OBJECT
    public:
        MapQuestMapAdapter();
        virtual ~MapQuestMapAdapter();
	};
